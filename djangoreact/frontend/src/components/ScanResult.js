...
const ScanResult = ({ pillList }) => {
  ...
  return (
    <ScanContainer>
      <ScanBox>
        <ScanImgStyle src={pillList['1.알약'][0].image} alt="스캔된 사진" onClick={() => setOpen1(true)} />
      ...
      <ScanBox2 isDataNull={pillList['2.알약']}>
        <ScanImgStyle src={pillList['2.알약'][0].image} alt="스캔된 사진" onClick={() => setOpen2(true)} />
      ...
      <ScanBox2 isDataNull={pillList['3.알약']}>
        <ScanImgStyle src={pillList['3.알약'][0].image} alt="스캔된 사진" onClick={() => setOpen3(true)} />
      ...
      <ScanBox2 isDataNull={pillList['4.알약']}>
        <ScanImgStyle src={pillList['4.알약'][0].image} alt="스캔된 사진" onClick={() => setOpen4(true)} />
      ...
      <ScanBox2 isDataNull={pillList['5.알약']}>
        <ScanImgStyle src={pillList['5.알약'][0].image} alt="스캔된 사진" onClick={() => setOpen5(true)} />
